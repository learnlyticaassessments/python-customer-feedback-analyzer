...
def run_all():
    ...
    for _, row in df.iterrows():
        ...
        scp_command = f"scp -o StrictHostKeyChecking=no -i ~/.ssh/id_rsa ubuntu@{ip}:/home/ubuntu/Desktop/customer_feedback_analyzer/student_workspace/solution.py {student_dir}/solution.py"
